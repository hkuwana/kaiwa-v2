	...
	<div class="privacy-content">
		...
		<section class="privacy-section">
			...
			<p>
				...
				data with OpenAI in accordance with OpenAI's privacy policy and data usage terms. This data sharing
			...
			<p>
				...
				"Enhanced Data Privacy" option in their User Preferences settings. However, opting out may result
				in reduced service quality or feature limitations as we may need to limit usage to maintain operational
				sustainability.
			</p>
