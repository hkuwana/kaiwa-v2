  ...
  <div class="control-section">
    ...
    <div class="control-buttons">
      ...
      {:else if store.isConnecting}
        <button disabled class="connecting-btn">
          🔄 Connecting...
        </button>
      {:else}
        <button on:click={handleStop} class="stop-btn">
          ⏹️ Stop Conversation
        </button>
      {/if}
    </div>
    ...
    {#if store.error}
      <div class="error-message">
        ❌ Error: {store.error}
        <button on:click={() => store.clearError()} class="clear-error-btn">
          ✕
        </button>
      </div>
    {/if}
    ...
    <div class="conversation-section">
      ...
      <div class="message-input">
        <textarea
          ...
          rows="3"
        ></textarea>
        <button on:click={handleSendMessage} class="send-btn">
          📤 Send
        </button>
      </div>
  ...
  <div class="status-section">
    ...
    <div class="status-grid">
      <div class="status-item">
        ...
        <span class="value {store.isConnected ? 'success' : store.isConnecting ? 'warning' : 'error'}">
...
<style>
  ...
  .setup-section, .control-section, .conversation-section, .status-section, .info-section {
    margin: 2rem 0;
    padding: 1.5rem;
