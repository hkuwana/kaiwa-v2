...
<div class="terms-container">
	...
	<div class="terms-content">
		...
		<section class="terms-section">
			...
			<p>
				While our AI systems are designed to provide helpful and accurate language learning
				assistance, you understand that AI-generated responses may occasionally contain errors or
				inaccuracies. You should use your own judgment and verify important information through
				additional sources when necessary.
			</p>
			<p>
				Any interactions with human support staff, customer service representatives, or other human
				personnel will be clearly identified as such within the Service interface.
			</p>
		</section>
