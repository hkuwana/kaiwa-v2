<script lang="ts">
  ...
  const competitors: Competitor[] = [
    ...
    },
    {
      ...
      strengths: [
        'Varied topics and easy onboarding',
    ...
    },
    {
      ...
      strengths: [
        'Human nuance and accountability',
  ...
  const capabilityMatrix = [
    { key: 'Emotional/relationship scenarios', speak: 'Partial', duolingo: 'No', elsa: 'No', talkpal: 'Partial', kaiwa: 'Core' },
    { key: 'Japanese/Korean/Chinese script comfort (furigana/romanization)', speak: 'Limited', duolingo: 'No', elsa: 'No', talkpal: 'Limited', kaiwa: 'Core' },
    { key: 'Realtime voice turn-taking', speak: 'Yes', duolingo: 'Limited', elsa: 'Yes (micro)', talkpal: 'Yes', kaiwa: 'Yes (conversation-first)' },
    { key: 'Code-switching/de‑escalation pedagogy', speak: 'Limited', duolingo: 'No', elsa: 'No', talkpal: 'No', kaiwa: 'Core' },
    { key: 'Continuity memory and topic carryover', speak: 'Limited', duolingo: 'No', elsa: 'No', talkpal: 'Limited', kaiwa: 'Core' },
    { key: 'Insider cultural hooks', speak: 'Limited', duolingo: 'No', elsa: 'No', talkpal: 'Limited', kaiwa: 'Core' }
  ];
...
<div class="min-h-screen bg-gradient-to-br from-base-100 to-base-200">
  <div class="container mx-auto px-4 py-10">
    ...
    <div class="mb-10 overflow-x-auto rounded-xl border border-base-300 bg-base-100 shadow">
      ...
      <div class="p-3 text-xs text-base-content/60">Qualitative assessment for internal planning. Not for external use.</div>
    </div>
