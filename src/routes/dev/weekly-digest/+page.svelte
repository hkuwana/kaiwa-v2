<script lang="ts">
	...
	async function sendDigest() {
		if (!confirm('Send weekly digest to all subscribers? This cannot be undone.')) {
			return;
		}
	...
	async function copyScriptContent() {
		...
		alert('Script content copied! Paste it into scripts/send-weekly-digest.ts');
	}
		...
		<div class="space-y-6">
			...
			<div class="card bg-base-200">
				<div class="card-body">
					...
					{#each content.productHighlights as highlight, i}
						<div class="space-y-2 rounded-lg border border-base-300 p-4">
							<div class="flex items-center justify-between">
