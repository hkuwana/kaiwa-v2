		...
		{#if showWeeklyPreview}
			<div class="card mb-8 bg-base-100 shadow-xl">
				<div class="card-body">
					...
					{#if !showSideBySide}
						<div class="overflow-hidden rounded-lg border-2 border-base-300 shadow-lg">
							<iframe
								title="Weekly Email Preview - Full Width"
								class="w-full h-[700px] border-0"
								srcdoc={weeklyPreviewHtml}
							/>
						</div>
					{/if}
					...
					{#if showSideBySide}
						<div class="grid-cols-1gap-6 grid">
							<!-- Desktop Preview -->
							<div>
								<div
									class="mb-2 flex items-center gap-2 text-sm font-semibold text-base-content/70"
								>
									<svg
										xmlns="http://www.w3.org/2000/svg"
										class="h-4 w-4"
								...
								<div class="overflow-hidden rounded-lg border-2 border-base-300 shadow-lg">
									<iframe
										title="Weekly Email Preview - Desktop"
								...
								<div class="flex justify-center">
									<div class="mockup-phone border-primary">
										...
										<div class="mockup-phone-display">
											<iframe
												title="Weekly Email Preview - Mobile"
