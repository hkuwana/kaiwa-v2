...
export const scenarioCategories = [
    {
        ...
        elements: 'A steaming mug of coffee on a rustic wooden table, a small vase with a single flower, a book left open.',
        ...
        artStyle: 'Emulate Studio Ghibli with detailed, hand-drawn backgrounds and soft, painterly light.',
        ...
        textures: 'Visible wood grain on the table, subtle reflections in the window, steam gently rising from the mug.',
