...
export const viralScenarios: ViralScenario[] = [
	{
		...
		situation: 'You\'ve been waiting in line at a busy coffee shop for 5 minutes. Someone clearly cuts in front of you and starts ordering.',
		context: 'It\'s your morning coffee run, you\'re already running a bit late, and there are people behind you who also saw what happened.',
	...
	},
	{
		...
		situation: 'Your close friend just got a very dramatic haircut that... doesn\'t look great. They\'re excited and ask: "What do you think? Be honest!"',
		context: 'You\'re meeting for lunch, they\'re clearly proud of their new look, and you can tell they\'ve spent money on this. They really want your genuine reaction.',
		targetLanguages: ['ja', 'de', 'es', 'fr', 'it', 'en', 'ko', 'zh', 'nl'],
		analysisWeights: {
			conflictStyle: 0.2,
	...
	},
	{
		...
		situation: 'You\'re 15 minutes late to meet someone important (could be work, could be personal). You\'re just arriving now and they\'ve been waiting.',
		context: 'The delay was partially your fault (you underestimated travel time) but there was also unexpected traffic. This person\'s time is valuable.',
	...
	},
	{
		...
		situation: 'It\'s 3 PM and your partner just called: "My mom wants you to come to family dinner tonight at 7. She\'s making your favorite dish!" You had other plans.',
		context: 'This is the first time you\'re meeting their extended family. It\'s clearly important to your partner, but you had plans to finish work and relax.',
	...
	},
	{
		...
		situation: 'Your friend group is excitedly planning dinner at a new trendy restaurant. The menu prices are way above your comfort zone, but everyone seems really excited.',
		context: 'It\'s someone\'s birthday celebration, and you don\'t want to be the party pooper, but the prices would seriously impact your budget.',
...
export function getViralScenariosForLanguage(languageCode: string): ViralScenario[] {
	return viralScenarios.filter(scenario =>
		!scenario.targetLanguages || scenario.targetLanguages.includes(languageCode)
	);
}
