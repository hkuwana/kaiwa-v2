...
export * as instructionsService from './instructions.service';
...
export * as userSettingsService from './user-settings.service';
export * as userMemoryService from './user-memory.service';
