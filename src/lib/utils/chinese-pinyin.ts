...
const PINYIN_MAP: Record<string, string> = {
	...
	'了': 'le', '不': 'bu', '在': 'zai', '有': 'you', '个': 'ge',
	'人': 'ren', '这': 'zhe', '中': 'zhong', '大': 'da', '为': 'wei',
	'上': 'shang', '们': 'men', '到': 'dao', '说': 'shuo', '国': 'guo',
	'年': 'nian', '着': 'zhe', '就': 'jiu', '那': 'na', '和': 'he',
	'要': 'yao', '她': 'ta', '出': 'chu', '也': 'ye', '得': 'de',
	'里': 'li', '后': 'hou', '自': 'zi', '以': 'yi', '会': 'hui',
	'家': 'jia', '可': 'ke', '下': 'xia', '而': 'er', '过': 'guo',
	...
	// Time and dates
	'今': 'jin', '天': 'tian', '日': 'ri', '月': 'yue', '时': 'shi',
	'分': 'fen', '秒': 'miao', '年': 'nian', '早': 'zao', '晚': 'wan',
	'上': 'shang', '下': 'xia', '午': 'wu', '点': 'dian',
	
	// Common verbs
	'吃': 'chi', '喝': 'he', '睡': 'shui', '走': 'zou', '来': 'lai',
	'去': 'qu', '看': 'kan', '听': 'ting', '说': 'shuo', '读': 'du',
	'写': 'xie', '学': 'xue', '习': 'xi', '工': 'gong', '作': 'zuo',
	'买': 'mai', '卖': 'mai', '开': 'kai', '关': 'guan', '给': 'gei',
	
	// Weather
	'气': 'qi', '很': 'hen', '热': 're', '冷': 'leng', '雨': 'yu',
	'雪': 'xue', '风': 'feng', '云': 'yun', '晴': 'qing',
	
	// Places and directions
	'北': 'bei', '京': 'jing', '上': 'shang', '海': 'hai', '广': 'guang',
	'州': 'zhou', '深': 'shen', '圳': 'zhen', '南': 'nan', '西': 'xi',
	'东': 'dong', '中': 'zhong', '外': 'wai', '内': 'nei', '前': 'qian',
	'后': 'hou', '左': 'zuo', '右': 'you', '旁': 'pang', '边': 'bian',
	
	// Family
	'父': 'fu', '母': 'mu', '儿': 'er', '女': 'nv', '子': 'zi',
	'哥': 'ge', '弟': 'di', '姐': 'jie', '妹': 'mei', '爱': 'ai',
	
	// Colors
	'红': 'hong', '黄': 'huang', '蓝': 'lan', '绿': 'lv', '白': 'bai',
	'黑': 'hei', '灰': 'hui', '紫': 'zi', '粉': 'fen', '橙': 'cheng',
	
	// Common phrases
	'谢': 'xie', '请': 'qing', '对': 'dui', '起': 'qi', '没': 'mei',
	'关': 'guan', '系': 'xi', '再': 'zai', '见': 'jian', '欢': 'huan',
	'迎': 'ying', '光': 'guang', '临': 'lin',
	
	// School and learning
	'学': 'xue', '校': 'xiao', '老': 'lao', '师': 'shi', '同': 'tong',
	'学': 'xue', '生': 'sheng', '书': 'shu', '文': 'wen', '语': 'yu',
	'言': 'yan', '英': 'ying', '法': 'fa', '德': 'de', '日': 'ri',
	
	// Food
	'饭': 'fan', '菜': 'cai', '肉': 'rou', '鱼': 'yu', '蛋': 'dan',
	'奶': 'nai', '茶': 'cha', '咖': 'ka', '啡': 'fei', '水': 'shui',
	'面': 'mian', '包': 'bao', '饺': 'jiao', '汤': 'tang', '米': 'mi',
	
	// Transportation
	'车': 'che', '船': 'chuan', '飞': 'fei', '机': 'ji', '火': 'huo',
	'地': 'di', '铁': 'tie', '公': 'gong', '交': 'jiao', '站': 'zhan',
	
	// Technology
	'电': 'dian', '脑': 'nao', '话': 'hua', '网': 'wang', '络': 'luo',
	'机': 'ji', '器': 'qi', '视': 'shi', '频': 'pin', '音': 'yin',
	'乐': 'yue', '游': 'you', '戏': 'xi',
	
	// Money and shopping
	'钱': 'qian', '块': 'kuai', '元': 'yuan', '角': 'jiao', '分': 'fen',
	'商': 'shang', '店': 'dian', '市': 'shi', '场': 'chang', '价': 'jia',
	'格': 'ge', '便': 'pian', '宜': 'yi', '贵': 'gui',
	
	// Body parts
	'头': 'tou', '眼': 'yan', '睛': 'jing', '鼻': 'bi', '嘴': 'zui',
	'手': 'shou', '脚': 'jiao', '身': 'shen', '体': 'ti', '心': 'xin',
	
	// Common adjectives
	'好': 'hao', '坏': 'huai', '新': 'xin', '旧': 'jiu', '多': 'duo',
	'少': 'shao', '高': 'gao', '矮': 'ai', '胖': 'pang', '瘦': 'shou',
	'快': 'kuai', '慢': 'man', '远': 'yuan', '近': 'jin', '长': 'chang',
	'短': 'duan', '宽': 'kuan', '窄': 'zhai', '深': 'shen', '浅': 'qian',
	
	// Additional common characters
	'首': 'shou', '都': 'du', '喜': 'xi', '欢': 'huan', '意': 'yi',
	'思': 'si', '想': 'xiang', '知': 'zhi', '道': 'dao', '问': 'wen',
	'题': 'ti', '答': 'da', '案': 'an', '方': 'fang', '法': 'fa',
	'感': 'gan', '觉': 'jue', '真': 'zhen', '假': 'jia', '对': 'dui',
	'错': 'cuo', '帮': 'bang', '助': 'zhu', '需': 'xu', '要': 'yao',
	
	// Question words and common phrases
	'怎': 'zen', '么': 'me', '样': 'yang', '什': 'shen', '哪': 'na',
	'谁': 'shei', '为': 'wei', '什么': 'shenme', '怎么': 'zenme', '怎样': 'zenyang',
	'多': 'duo', '少': 'shao', '几': 'ji', '哪里': 'nali', '什么时候': 'shenmeshihou',
	
	// More verbs and adjectives
	'做': 'zuo', '用': 'yong', '让': 'rang', '叫': 'jiao', '找': 'zhao',
	'想': 'xiang', '觉': 'jue', '帮': 'bang', '告': 'gao', '诉': 'su',
	'拿': 'na', '放': 'fang', '带': 'dai', '送': 'song', '收': 'shou',
	'打': 'da', '拉': 'la', '推': 'tui', '举': 'ju', '抱': 'bao'
};
 ...
 */
export function pinyinize(text: string, options: {
	withTones?: boolean;
	separator?: string;
} = {}): string {
