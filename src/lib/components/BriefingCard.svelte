	...
	>
		...
		>
			...
			<div class="space-y-2 sm:space-y-4">
				<!-- Language Section - With rotating text animation -->
				{#if selectedLanguage}
					<div
					...
					>
						...
						<div class="flex-1">
							...
							<div class="text-base font-semibold sm:text-lg">
								<span class="text-rotate inline-block">
									<span class="rotate-text">
										{#each languageVariants as variant, i (i)}
											<span class="rounded px-2 py-0.5 {variant.color}">{variant.text}</span>
										{/each}
									</span>
								</span>
							</div>
				...
				<!-- Scenario Section - Image-full card style -->
				{#if selectedScenario}
					<div
