...
<div class="relative rounded-2xl border border-base-300/60 bg-base-100/70 p-6 shadow-sm">
	...
	<p class="mx-auto mb-5 max-w-xl text-center text-base-content/70">
		Share with someone who wants to speak for adventures and for life
	</p>
	...
	<div class="flex flex-wrap items-center justify-center gap-3">
		...
		<a
			...
			rel="noopener"
			onclick={() => {
				track('share_whatsapp_click', { source });
				bumpShareCount();
				thank();
			}}
		>
...
<style>
	...
	.scale-in {
		animation: scaleIn 320ms ease-out;
	}
	@keyframes scaleIn {
		from {
