...
- Aligns with brand identity and target audience
...
- Should we use illustrations, photography, or a mix?

**Deliverable**: Visual mood board with 10-15 reference examples
...
- **Illustration Style**:
  ...
  - Level of detail (simple, detailed, semi-realistic)
  - Shading approach (flat, gradient, textured)
- **Character Design**:
  - Proportions and anatomy style
  - Expression approach (realistic, exaggerated, minimal)
...
**Deliverable**: Style guide document with visual examples
...
- Emphasizes clarity and calmness

**Pros**: Timeless, accessible, easy to produce consistently
**Cons**: May feel generic if not differentiated
...
**Pros**: Distinctive, memorable, conveys care
**Cons**: Harder to maintain consistency, may age poorly
...
**Pros**: Professional, scalable, on-trend
**Cons**: May feel cold or intimidating for language learners
...
- Unique and ownable
- Tells a story about language learning

**Pros**: Unique, meaningful, inclusive
**Cons**: Complex to execute, risk of appropriation if done poorly
...
- [ ] Train team on asset usage and requests

---

## Related Documents

- [corporate-identity.md](corporate-identity.md) - Brand voice and messaging
- [scenario-thumbnails.md](../3-features/scenario-thumbnails.md) - Technical implementation
- Archive: [ghibli-character-implementation.md](../7-archive/archive-ghibli-character-implementation.md) - Previous character style

---

## Questions for Discussion

1. **Target feeling**: When a user sees Kaiwa visuals, what should they feel? (excited? calm? confident?)
2. **Differentiation**: What makes our visual style uniquely "Kaiwa"?
3. **Scalability**: Can we maintain this style as we grow?
4. **Cultural sensitivity**: How do we represent diverse cultures respectfully?
5. **Budget**: What's realistic for our current stage?
...
- Visual consistency across all touchpoints (app, web, marketing)
...
**Status**: Awaiting team input and decision
